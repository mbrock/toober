defmodule ToobaWeb.MessageLiveTest do
  use ToobaWeb.ConnCase

  import Phoenix.LiveViewTest
  import Tooba.ZigbeeFixtures

  @create_attrs %{payload: %{}, topic: "some topic", inserted_at: "2023-11-03T21:26:00"}
  @update_attrs %{payload: %{}, topic: "some updated topic", inserted_at: "2023-11-04T21:26:00"}
